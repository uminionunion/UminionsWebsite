...
export function setupChat(io) {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('loadArchivedMessages', async (data) => {
...
export async function roomHasMessages(room) {
    try {
